import { FETCH_TESTS, FETCH_TESTS_FAILURE, FETCH_TESTS_SUCCESS, CREATE_TEST, CREATE_TEST_FAILURE, CREATE_TEST_SUCCESS, RESET_NEW_TEST } from '../actions/';
...
export default function(state = INITIAL_STATE, action){
  ...
  case CREATE_TEST_SUCCESS:
    return {...state, newTest: {test:action.payload, error:null, loading: false}}
